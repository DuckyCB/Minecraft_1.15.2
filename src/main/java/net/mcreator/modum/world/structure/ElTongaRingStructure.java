...
package net.mcreator.modum.world.structure;
...
public class ElTongaRingStructure extends ModumModElements.ModElement {
	public ElTongaRingStructure(ModumModElements instance) {
		super(instance, 21);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("modum", "el_ring"));
						if (template == null)
							return false;
